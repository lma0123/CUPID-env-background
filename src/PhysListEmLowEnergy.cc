...
// ********************************************************************
//
/// \file radioactivedecay/rdecay02/src/PhysListEmLowEnergy.cc
/// \brief Implementation of the PhysListEmLowEnergy class
//
...
auto theParticleIterator = GetParticleIterator();
  ...
  while( (*theParticleIterator)() ){
    ...
    if (particleName == "gamma") {
      ...
      ionIoni->SetStepFunction(1.e-3, 1.e-3*CLHEP::um);
      ...
      G4ionIonisation* ionIoni = new G4ionIonisation();
      ionIoni->SetStepFunction(0.1, 1.E-1*CLHEP::um);
      pmanager->AddProcess(ionIoni,                   -1, 2, 2);
      pmanager->AddProcess(new G4NuclearStopping(),   -1, 3,-1);
      ...
      hIonisation->SetPixeProjectileMinEnergy(1.* CLHEP::keV);
      hIonisation->SetPixeProjectileMaxEnergy(200. * CLHEP::MeV);
      hIonisation->SetCutForSecondaryPhotons(250. * CLHEP::eV);
      hIonisation->SetCutForAugerElectrons(250. * CLHEP::eV);
