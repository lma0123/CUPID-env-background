...
{   
  ...
  fGammaCutCmd = new G4UIcmdWithADoubleAndUnit("//phys/setGCut",this);  
  ...
  fElectCutCmd = new G4UIcmdWithADoubleAndUnit("//phys/setECut",this);  
  ...
  fProtoCutCmd = new G4UIcmdWithADoubleAndUnit("//phys/setPCut",this);  
  ...
  fAllCutCmd = new G4UIcmdWithADoubleAndUnit("//phys/setCuts",this);
  ...
  fECutCmd = new G4UIcmdWithADoubleAndUnit("//phys/TargetCuts",this);
  ...
  fMCutCmd = new G4UIcmdWithADoubleAndUnit("//phys/DetectorCuts",this);
  ...
  fPListCmd = new G4UIcmdWithAString("//phys/SelectPhysics",this);
