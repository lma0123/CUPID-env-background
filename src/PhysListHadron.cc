...
auto theParticleIterator = GetParticleIterator();
  ...
  theHandler->SetMinEForMultiFrag(5*CLHEP::MeV);  
  ...
  theTheoModel->SetMinEnergy(10*CLHEP::GeV);  // 15 GeV may be the right limit
  ...
  while( (*theParticleIterator)() ) {
    ...
    if (particleName != "neutron") {  
      ...
      if (particle->GetPDGMass() > 110.*CLHEP::MeV && fTheElasticProcess.IsApplicable(*particle)
  ...
  theBC->SetMaxEnergy(10.5*CLHEP::GeV);
...
if( ActiveNeutrons ) {
  ...
  theHPNeutronInelasticModel->SetMaxEnergy(20.*CLHEP::MeV);
  ...
  neutronBC->SetMinEnergy(19.*CLHEP::MeV);
  neutronBC->SetMaxEnergy(10.5*CLHEP::GeV);
  ...
  theIonBC->SetMinEnergy(1*CLHEP::MeV);
  theIonBC->SetMaxEnergy(20*CLHEP::GeV);
